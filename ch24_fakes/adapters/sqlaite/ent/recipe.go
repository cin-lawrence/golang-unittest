...
func (_m *Recipe) QueryRecipeingredient() *RecipeIngredientQuery {
	return NewRecipeClient(_m.config).QueryRecipeingredient(_m)
}
...
func (_m *Recipe) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", _m.MealType))
	builder.WriteByte(')')
