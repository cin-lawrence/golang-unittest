...
func (_m *Pantry) assignValues(columns []string, values []any) error {
...
func (_m *Pantry) Value(name string) (ent.Value, error) {
	return _m.selectValues.Get(name)
}

// QueryIngredient queries the "ingredient" edge of the Pantry entity.
func (_m *Pantry) QueryIngredient() *IngredientQuery {
	return NewPantryClient(_m.config).QueryIngredient(_m)
}
...
func (_m *Pantry) Update() *PantryUpdateOne {
	return NewPantryClient(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the Pantry entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *Pantry) Unwrap() *Pantry {
