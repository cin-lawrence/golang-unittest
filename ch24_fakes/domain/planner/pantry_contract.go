...
type Pantry interface {
	GetIngredients(ctx context.Context) (ingredient.Ingredients, error)
	Store(context.Context, ...ingredient.Ingredient) error
	Remove(context.Context, ...ingredient.Ingredient) error
}
