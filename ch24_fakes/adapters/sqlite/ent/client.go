...
import (
	...
	"ch24/fakes/adapters/sqlite/ent/migrate"
...
func (c *IngredientClient) UpdateOne(_m *Ingredient) *IngredientUpdateOne {
	mutation := newIngredientMutation(c.config, OpUpdateOne, withIngredient(_m))
...
func (c *IngredientClient) DeleteOne(_m *Ingredient) *IngredientDeleteOne {
...
func (c *IngredientClient) QueryPantry(_m *Ingredient) *PantryQuery {
...
func (c *IngredientClient) QueryRecipeingredient(_m *Ingredient) *RecipeIngredientQuery {
...
// UpdateOne returns an update builder for the given entity.
func (c *PantryClient) UpdateOne(_m *Pantry) *PantryUpdateOne {
	mutation := newPantryMutation(c.config, OpUpdateOne, withPantry(_m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *PantryClient) DeleteOne(_m *Pantry) *PantryDeleteOne {
	return c.DeleteOneID(_m.ID)
}
...
func (c *PantryClient) QueryIngredient(_m *Pantry) *IngredientQuery {
...
func (c *RecipeClient) QueryRecipeingredient(_m *Recipe) *RecipeIngredientQuery {
	query := (&RecipeIngredientClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
func (c *RecipeIngredientClient) QueryIngredient(_m *RecipeIngredient) *IngredientQuery {
	query := (&IngredientClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
